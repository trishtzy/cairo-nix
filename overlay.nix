...
let
  ...
  versions = [
    ...
    }
    {
      cairo = {
        version = "2.6.0";
        srcHash = "sha256-ywswNh9+l5WYgIQTXYJBqY3kiq49JP/7kNwHIN4DsDg=";
        archiveHash = "sha256-15UhpWza4PmpODWR5A+/mTVOBi0bcYj2h6eHGeIu+0E=";
        cargoHash = "sha256-4JOxgdx5pyTiHtpexevVEhTOwiVXuXZsKuuJd17OioE=";
      };
      scarb = {
        version = "2.6.0";
        srcHash = "sha256-eUbWzwWzjah6tQjRyU9W0AdfMEiKBM13YcehQEbygw8=";
        cargoHash = "sha256-LyWtN9eQPP+SBNKHgTFpwleUHCu0EllwV08BqKbnsFc=";
        cargoLock = null;
      };
    }
    {
      ...
      scarb = {
        version = "2.6.3";
        srcHash = "sha256-1nJFhSPhfXf5nqGVmS4F2kqGmRhlr9m+u1ZgY9sFWcM=";
        cargoHash = "sha256-dJ1P3NAMceaaOUTLObUGTwEU9PbhrxrqIjYTDK6P7oY=";
        cargoLock = null;
      };
    }
    {
    ...
    {
      toolchainVersion = "2.8.2";
      cairo = {
        version = "2.8.2";
        srcHash = "sha256-vBdIGkdQa/csqsu4DbgIYitVbDLDUAFmIUytZ7IcxNk=";
        archiveHash = "sha256-2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
        cargoHash = "sha256-w3kzEM34HYQ6KgILaDpmZbCgAh8Ql24DRe12woUAhVI=";
      };
      scarb = {
        version = "2.8.2";
        srcHash = "sha256-4AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
        cargoHash = "sha256-5BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB=";
        cargoLock = null;
      };
    }
  ];
...
in
{
  cairo-bin = (toolchains // {
    stable = toolchains."2.8.2";
    beta = toolchains."2.8.2";
  });
}
